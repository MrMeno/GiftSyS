    ...
    init: function() {
      ...
      if (length < allNumber) {
        for (var i = length; i <= allNumber - length; i++) {
          switch (i) {
            case 1:
              $this.append("<li>一等奖</li>");
              break;
            case 3:
              $this.append("<li>二等奖</li>");
              break;
            case 5:
              $this.append("<li>三等奖</li>");
              break;
            case 7:
              $this.append("<li>阳光普照</li>");
              break;
            default:
              $this.append("<li>绝望吗</li>");
              break;
          }
        }
      }
      ...
      function initOne() {
        children.each(function(index) {
          if (index >= 0 && index <= col - 1) {
            ...
            if (index == (col + line) * 2 - 1) {
              $(this).css({
                bottom: 0,
                right: (index % col) * width + spacing
              });
            }
          }
        });
